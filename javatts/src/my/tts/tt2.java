 ...
 * @author Lord Sasuke
 */
public class tt2 extends javax.swing.JFrame {

    /**
     * Creates new form tt2
     */
    public tt2() {
        initComponents();
    }
...
private static final String VOICENAME="kevin";//declaration of voice
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       Voice voices;
        ...
        vma=VoiceManager.getInstance();//voice manager 
        //voices=vma.getVoice(VOICENAME);
        
        
        voices=vma.getVoice("mbrola_in1");
        voices.allocate();
        try{
        voices.speak(gg.getText());
        }
        catch(Exception e){
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tt2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
